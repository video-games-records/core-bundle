...
ALTER TABLE `vgr_game` CHANGE `nbMembre` `nbUser` INT(11) NOT NULL;
ALTER TABLE `vgr_game` CHANGE `nbRecord` `nbChart` INT(11) NOT NULL;
ALTER TABLE `vgr_game` CHANGE `boolDLC` `boolDlc` TINYINT(1) NOT NULL;
